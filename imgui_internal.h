...
namespace ImGui
{
    ...
    IMGUI_API void          RenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float sz);
    ...
    bool style(const char* label, bool selected);
    bool lang(const char* label, bool selected);
